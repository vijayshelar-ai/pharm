...
class PharmacyManagementSystem:
    def __init__(self, root, username=None):
        ...
        down_frame=Frame(DataFrameRight,bd=3,relief=RIDGE,bg="white")
        down_frame.place(x=400,y=154,width=115,height=163)
        
        btnAddmed = Button(down_frame, text="ADD", font=("arial", 12, "bold"), bg="green", fg="white", width=10, pady=4, command=self.AddMed)
        btnAddmed.grid(row=0, column=0)
        
        #==========update button=======
        
        btnUpdatedMed = Button(down_frame, command=self.UpdateMed, text="UPDATE", font=("arial", 12, "bold"), bg="purple", fg="white", width=10, pady=4)
        btnUpdatedMed.grid(row=1, column=0)
        
      
        #==========delete button=======
        
        btndelmed= Button(down_frame, command=self.DeleteMed, text="DELETE", font=("arial", 12, "bold"), bg="red", fg="white", width=10, pady=4)       
        btndelmed.grid(row=2, column=0)
        
        #=========clear button=======
         
        btnClearmed= Button(down_frame,text="CLEAR",command=self.ClearMed,font=("arial", 12, "bold"),bg="Orange", fg="white",width=10,pady=4)
